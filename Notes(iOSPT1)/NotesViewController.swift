...
class NotesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, NoteTableViewCellDelegate {
    ...
    /*
     // Delegator View
     1. Create Protocol
     2. Add properties and methods to protcol
     3. In delegator, create (weak var delegate) porperty of type [Protocol])
     ...
     4. Add code in the delegate method that you want the delegate to complete
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toDetail" {
            ...
            let detailVC = segue.destination as? NotesDetailViewController else { return}
